...
public class PersonControllerImlTest {
   ...
   // private CustomResponse Ok;
    ...
    public void addPerson() {
        ...
        Person person = new Person(12,"hrishi","hrishikesh22@gmail.com", 2345,"2012-09-26",categories);
    ...
    public void updatePerson(){
        Categories categories = new Categories(12);
        Person person = new Person(12,"hrishi","hrishikesh22@gmail.com",2345,"2023-09-12",categories);
        person.setName("hrishi");
        Person newEmp= new Person("hrash","hrishikesh222@gmail.com",23145,"2022-05-12",categories);
    ...
    public void deleteById(){
        Categories categories = new Categories(12);
        Person person = new Person("hrishi","hrishikesh22@gmail.com",1234,"2022-03-22",categories);
        person.setId(12);
